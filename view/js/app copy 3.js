document.addEventListener(
      ...
      fetch(serverLink + "ballot/" + candidateLink , 
    {
      ...
      .then((result) => { 
       ...
       try{
               ...
               // console.log("3:" + result.candidates.length)

               if (result.candidates != undefined){
                    if (result.candidates.length != 0){
                        console.log(candidateLink + " has been added.")
                        //candidtes not empty
               ...
               // console.log(result.candidates.length == undefined)
               // console.log(candidateLink + " has been added.")
              //  if (result.candidates.length > 0){
              //  
              //  }
    ...
    while (voting < 14){
          ...
          //using kayvia come here
          if (localStorage.getItem(candidatePositions[voting]) != "true"){
            //console.log(candidatePositions[voting] + " isn't empty")
            //console.log(localStorage.getItem(candidatePositions[voting]) == 'false');

            candidatesToRun.push(candidatePositions[voting]);
            //console.log("Get cands" + localStorage.getItem(candidatesToRun[voting]))
