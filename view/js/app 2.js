document.addEventListener(
    ...
    fetch(serverLink + "ballot/" + candidateLink , 
  {
    ...
    .then((result) => { 
        //console.log(result)
        try {
            if (result.candidates != 0 && result.candidates.length != 0){
              console.log("For the candidate " + candidateLink + " it is " + (result.candidates != 0))
            //  console.log()
              localStorage.setItem(candidateLink, true);
              localStorage.getItem(candidateLink);
      ...
      //console.log("The success for " + candidateLink + " is " + result.success)
       //if (result.success != false){
       // console.log("You will print: " + candidateLink)
        //console.log("Result: " + result.success)
       // try {
       //   result.candidates.length;   // You cannot convert a number to upper case
          
          //console.log("The length for " + candidateLink + " is " + result.candidates.length)
          //console.log("For this candidate: " + (result.candidates.length != 0))
        // console.log(result.candidates)
      //    if (result.candidates.length != 0){
           // console.log("I will add " + candidateLink)
        ...
        //  console.log("They will be added to the list " + localStorage.getItem(candidateLink))
     //   }
     //   catch(err) {
    ...
    function getCandidatesToRun(){
      while (voting < 14){
        ...
        if (localStorage.getItem(candidatePositions[voting]) != "true"){
          //console.log("For candidates voting: " + candidatePositions[voting])
    ...
    if(ballotOptions != null){
      //console.log("These are the candidates to run before: " + candidatesToRun)
      getCandidatesToRun();
      //console.log("These are the candidates to run: " + candidatesToRun)
